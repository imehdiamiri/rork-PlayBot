                ...
                <Animated.View
                  ...
                  style={[
                    styles.surfaceCard,
                    {
                      ...
                      overflow: 'hidden',
                      shadowColor: '#AF52DE',
                      borderColor: isExpanded ? 'rgba(175, 82, 222, 0.4)' : 'rgba(255,255,255,0.05)',
                    },
                  ]}
                >
                  {Platform.OS === 'ios' && BlurViewComponent ? (
...
const styles = StyleSheet.create({
  ...
  emptyResults: { alignItems: 'center', paddingVertical: 32, gap: 14 },
  emptyIconWrapper: { width: 72, height: 72, justifyContent: 'center', alignItems: 'center', position: 'relative' },
  emptyIconBg: { ...StyleSheet.absoluteFillObject, borderRadius: 36 },
  emptyResultsTitle: { color: 'white', fontSize: 15, fontWeight: 'bold' },
  emptyResultsText: { color: 'rgba(255,255,255,0.6)', fontSize: 12, textAlign: 'center', paddingHorizontal: 24 },
  resultsContainer: { gap: 12 },
  resultsHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 },
  badge: { backgroundColor: 'rgba(255,255,255,0.08)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 20 },
  badgeText: { color: 'rgba(255,255,255,0.6)', fontSize: 12, fontWeight: 'bold' },
  ...
  expandButton: { width: 30, height: 30, justifyContent: 'center', alignItems: 'center' },
  expandedContent: { marginTop: 16, gap: 8 },
